...
![SleepVivo ホーム画面](assets/img/home.png)
...
3. [SleepVivo の基本機能](user-guide/basic-functions.md)で、眠る前から起きるまでの流れを確認します。
4. [入眠誘導](user-guide/sleep-induction.md)と[起床誘導](user-guide/wake-induction.md)で、基本の睡眠サポートを確認します。
5. 日によって予定が変わる場合は、[スケジュール](user-guide/scheduler.md)を確認します。
